        ...
        <div className="max-w-4xl mx-auto px-6 py-20 animate-fade-in-up delay-100">
          <div className="glass-panel p-10 md:p-16 rounded-3xl">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-6xl font-serif font-bold text-white mb-8 leading-tight drop-shadow-md">
                {blog.title}
              </h1>
            ...
            <img
              ...
              className="w-full h-[30rem] object-cover rounded-xl mb-16 filter grayscale hover:grayscale-0 transition-all duration-1000 shadow-2xl"
            />
